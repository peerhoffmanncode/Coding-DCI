...
class CarSearch(forms.Form):
    ...
    cars = forms.CharField(initial=CAR_CHOICES[1][1], label="Choose your car", widget=forms.Select(choices=CAR_CHOICES), help_text="All our cars are premium, if you scratch you pay!")
