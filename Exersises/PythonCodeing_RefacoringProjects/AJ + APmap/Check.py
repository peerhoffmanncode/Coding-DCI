...
# Convert the country Dict to ALL UPPERCASE KEYS and add ", "+KEY+"," to the key name. Important for if statement later!
for k,v in list(countries.items()):
    del countries[k]
    countries.update({", " + k.upper()+",": v})

# Convert the Dict to ALL UPPERCASE KEYS and add KEY+"," to the key name. Important for if statement later!
...
"""+"""    XXXXXXXXXXX     """+"""XXXXXXXXXXXXXXXXXXXXXXX:                               .:dKX0kOWXXXXXXXXXXXXXXXXXXXXXXXWWX: """+t17+"""     """+t21+uu+""" """+yy+AE+""" ,l,;l'    ,do'   .lc                                      .dWKkKWXXXXXXXXXXXXXXXXXXXXX"""+"""   XXXXXXXXXXX    """+"""
"""+"""   X           X    """+"""XXXXXXXXXXXXXXXXXXXXXWd.         """+t2+"""                 .lkkOXWXXXXXXXXXXXXXXXXXXXXXXXXXXNd;:c. .:lol:."""+vv+ww+WW+AX+AF+"""0Kxx0kc.  cKx,.  .,'                                   .;lOWWk; XXXXXXXXXXXXXXXXXXXXXX"""+"""   X          X   """+"""
"""+"""  X             X   """+"""XXXXXXXXXXXXXXXXXXXXXX:                           .cOWXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXK,  """+t19+""",kNXXkk..xco,"""+AB+"""c;,'..'::."""+t153+"""KO,    """+aa+"""                             .;,  """+t171+"""XXXk  XXXXXXXXXXXXXXXXXXXXXX"""+"""   X           X  """+"""
"""+"""  X             X   """+"""XXXXXXXXXXXXXXXXXXXXXNo.                         ;KXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXK: """+t16+""",kK0Okxx0x."""+t18+"."+AC+"""."""+AD+""" """+t140+"""  """+UU+VV+"""k'  """+ZZ+"""       """+cc+"""                      .clkk  0WWNO;"""+t163+"""XXXXXXXXXXXXXXXXXXXX"""+"""   X           X  """+"""
"""+"""  X             X   """+"""XXXXXXXXXXXXXXXXXXXXXXXc.                       'OXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXNd,;;'....."""+t82+"""WWXX  N K0kd' """+RR+SS+"""  ..          """+bb+"""              """+t165+"""       .lNXk"""+t172+"""c   XXXXXXXXXXXXXXXXXXXXXXX"""+"""   X           X  """+"""
"""+"""  XXXXXXXXXXXXXXX   """+"""XXXXXXXXXXXXXXXXXXXXXXXNk'                   .;xKWXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXKc."""+t84+"""       .:okXk:cx0K0Oo."""+QQ+"""      """+t139+"""  """+YY+"""                               .kXWNKdxKWXXXXXXXXXXXXXXXXXXXXXXXXX"""+"""   XXXXXXXXXXXXX  """+"""
"""+"""  X             X   """+"""XXXXXXXXXXXXXXXXXXXXXXXXWd;,.        .,,':lc.,0XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXWXc.                   """+t80+"""   """+OO+PP+"""  """+TT+""";.         """+XX+"""       """+dd+" "+ee+"""                :XXXXWWXXXXXXXXXXXXXXXXXXXXXXXXXXX"""+"""   X              """+"""
"""+"""  X             X   """+"""XXXXXXXXXXXXXXXXXXXXXXXXXNd:;.  """+t3+"""  ;0WNXWXXx'xXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXo.       """+t83+"""      """+t81+"""       ;;.     .;ll:,.....             """+t178+"""             .dNXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"""+"""   X              """+"""
"""+"""  X             X   """+"""XXXXXXXXXXXXXXXXXXXXXXXXXXWxcl'    '0XXXXXXN0okXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXNl"""+t85+"""                          cd. """+t147+NN+MM+"""':xKKOd'    """+t164+"""   .."""+t175+ff+"""      ..:xx0XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"""+"""   X              """+"""
"""+"""  X             X   """+"""XXXXXXXXXXXXXXXXXXXXXXXXXXXWXXO'   .OXXXdxXX00kdkXXNXXXXXXXXXXXXXXXXXXXXXXXXXXXXX0'   """+t86+"""                       .dx.       """+t150+"""WXXXKo:.      .l00c.      .::d0KNWXNXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"""+"""   X              """+"""
